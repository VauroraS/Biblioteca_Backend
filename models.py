...
class Lector(db.Model):
    ...
    reservas = db.relationship('Reserva', back_populates='lector', lazy='dynamic')
    prestamos = db.relationship('Prestamo', back_populates='lector', lazy='dynamic')
...
class Libro(db.Model):
    ...
    reservas = db.relationship('Reserva', back_populates='libro', lazy='dynamic')
    prestamos = db.relationship('Prestamo', back_populates='libro', lazy='dynamic')
    etiquetas = db.relationship('LibroEtiqueta', back_populates='libro', lazy='dynamic')
...
class Categoria(db.Model):
    ...
    libros = db.relationship('Libro', back_populates="categoria", lazy='dynamic')
...
class Prestamo(db.Model):
    ...
    lector = db.relationship('Lector', back_populates='prestamos')
...
class Reserva(db.Model):
    ...
    lector = db.relationship('Lector', back_populates='reservas')
...
class Etiqueta(db.Model):
    ...
    libros = db.relationship('LibroEtiqueta', back_populates='etiqueta', lazy='dynamic')
...
class LibroEtiqueta(db.Model):
    ...
    id_libros_etiquetas = db.Column(db.Integer, primary_key=True)
